...
## **5.2 Registration Status Lifecycle**
...
## **5.3 Multi-Attendee Rule**

* 1 primary attendee  
* Up to 4 additional names  
* `attendee_count` used for pricing

---

## **5.4 Free Event Flow**

1. Registration submitted (phone required).  
...
* payments  
* event\_media  
* broadcast\_messages (future)  
* broadcast\_deliveries (future)
