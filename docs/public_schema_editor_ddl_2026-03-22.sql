...
CREATE TABLE IF NOT EXISTS "public"."booking_side_effects" (
    ...
    CONSTRAINT "booking_side_effects_effect_intent_check" CHECK (("effect_intent" = ANY (ARRAY['SEND_BOOKING_CONFIRMATION_REQUEST'::"text", 'SEND_BOOKING_CONFIRMATION'::"text", 'SEND_PAYMENT_LINK'::"text", 'SEND_PAYMENT_REMINDER'::"text", 'SEND_BOOKING_CANCELLATION_CONFIRMATION'::"text", 'SEND_BOOKING_EXPIRATION_NOTIFICATION'::"text", 'SEND_BOOKING_REFUND_CONFIRMATION'::"text", 'SEND_EVENT_REMINDER'::"text", 'CREATE_STRIPE_CHECKOUT'::"text", 'VERIFY_EMAIL_CONFIRMATION'::"text", 'VERIFY_STRIPE_PAYMENT'::"text", 'CREATE_STRIPE_REFUND'::"text", 'RESERVE_CALENDAR_SLOT'::"text", 'UPDATE_CALENDAR_SLOT'::"text", 'CANCEL_CALENDAR_SLOT'::"text"]))),
...
CREATE TABLE IF NOT EXISTS "public"."events" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "marketing_content" "jsonb" DEFAULT '{}'::"jsonb" NOT NULL,
...
CREATE TABLE IF NOT EXISTS "public"."payments" (
    ...
    "stripe_credit_note_url" "text",
    CONSTRAINT "payments_amount_cents_check" CHECK (("amount" >= (0)::numeric)),
    CONSTRAINT "payments_refund_status_check" CHECK (("refund_status" = ANY (ARRAY['NONE'::"text", 'PENDING'::"text", 'SUCCEEDED'::"text", 'FAILED'::"text", 'CANCELED'::"text"]))),
...
CREATE TABLE IF NOT EXISTS "public"."session_type_availability_windows" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "session_type_availability_windows_time_check" CHECK (("start_local_time" < "end_local_time")),
    CONSTRAINT "session_type_availability_windows_weekday_check" CHECK ((("weekday_iso" >= 1) AND ("weekday_iso" <= 7)))
);


ALTER TABLE "public"."session_type_availability_windows" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."session_type_week_overrides" (
    "session_type_id" "uuid" NOT NULL,
    "week_start_date" "date" NOT NULL,
    "mode" "text" DEFAULT 'AUTO'::"text" NOT NULL,
    "override_weekly_booking_limit" integer,
    "note" "text",
    "updated_by" "text",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "session_type_week_overrides_limit_check" CHECK ((("override_weekly_booking_limit" IS NULL) OR ("override_weekly_booking_limit" > 0))),
    CONSTRAINT "session_type_week_overrides_mode_check" CHECK (("mode" = ANY (ARRAY['AUTO'::"text", 'FORCE_OPEN'::"text", 'FORCE_CLOSED'::"text"])))
);


ALTER TABLE "public"."session_type_week_overrides" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."session_types" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "availability_mode" "text" DEFAULT 'shared_default'::"text" NOT NULL,
    "availability_timezone" "text",
    "weekly_booking_limit" integer,
    "slot_step_minutes" integer,
    CONSTRAINT "session_types_availability_mode_check" CHECK (("availability_mode" = ANY (ARRAY['shared_default'::"text", 'dedicated'::"text"]))),
    ...
    CONSTRAINT "session_types_slot_step_minutes_check" CHECK ((("slot_step_minutes" IS NULL) OR ("slot_step_minutes" > 0))),
    CONSTRAINT "session_types_status_check" CHECK (("status" = ANY (ARRAY['DRAFT'::"text", 'ACTIVE'::"text", 'HIDDEN'::"text"]))),
    CONSTRAINT "session_types_weekly_booking_limit_check" CHECK ((("weekly_booking_limit" IS NULL) OR ("weekly_booking_limit" > 0)))
);
...
ALTER TABLE ONLY "public"."session_type_availability_windows"
    ADD CONSTRAINT "session_type_availability_windows_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."session_type_week_overrides"
    ADD CONSTRAINT "session_type_week_overrides_pkey" PRIMARY KEY ("session_type_id", "week_start_date");
...
CREATE INDEX "idx_session_type_availability_windows_lookup" ON "public"."session_type_availability_windows" USING "btree" ("session_type_id", "weekday_iso", "sort_order");
...
ALTER TABLE ONLY "public"."booking_side_effect_attempts"
    ADD CONSTRAINT "booking_side_effect_attempts_api_log_id_fkey" FOREIGN KEY ("api_log_id") REFERENCES "public"."api_logs"("id") ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."session_type_availability_windows"
    ADD CONSTRAINT "session_type_availability_windows_session_type_id_fkey" FOREIGN KEY ("session_type_id") REFERENCES "public"."session_types"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."session_type_week_overrides"
    ADD CONSTRAINT "session_type_week_overrides_session_type_id_fkey" FOREIGN KEY ("session_type_id") REFERENCES "public"."session_types"("id") ON DELETE CASCADE;
...
ALTER TABLE "public"."session_type_availability_windows" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."session_type_week_overrides" ENABLE ROW LEVEL SECURITY;
...
GRANT ALL ON TABLE "public"."session_type_availability_windows" TO "anon";
GRANT ALL ON TABLE "public"."session_type_availability_windows" TO "authenticated";
GRANT ALL ON TABLE "public"."session_type_availability_windows" TO "service_role";



GRANT ALL ON TABLE "public"."session_type_week_overrides" TO "anon";
GRANT ALL ON TABLE "public"."session_type_week_overrides" TO "authenticated";
GRANT ALL ON TABLE "public"."session_type_week_overrides" TO "service_role";
